...
RESULTFOLDER_LR="$RESULTFOLDER"/LR_DMRcount/noThinning/LR_DMRcount_Fisher
OUTPUTFOLDER="$RESULTFOLDER"/AUCs/newDataSplits/noThinning/discovery
MODELFILENAME="DMRcounts_allClasses"

NAMEID="LR_DMRcount_Fisher"
