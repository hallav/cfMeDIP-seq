...
FEATURELISTFILE_TOP="$RESULTFOLDER"/DMRs/totalReadcount10_"$THINNING"/Fishers_exact_test/found_DMRS_allClasses_top_
FEATURELISTFILE_BOTTOM="$RESULTFOLDER"/DMRs/totalReadcount10_"$THINNING"/Fishers_exact_test/found_DMRS_allClasses_bottom_

RESULTFOLDER_ourModel="$RESULTFOLDER"/LR_DMRcount/totalReadcount10_"$THINNING"_Fisher
OUTPUTFOLDER="$RESULTFOLDER"/AUCs/totalReadcount10_"$THINNING"_validation
MODELFILENAME="DMRcounts_allClasses"

NAMEID="LR_DMRcounts_Fisher"
...
VAR1="$RESULTFOLDER_ourModel"/"$MODELFILENAME"
VAR2="$DATASPLITFILE"
