...
FEATURELISTFILE_TOP="$RESULTFOLDER"/DMRs/sameReadcount10_"$THINNING"/Fishers_exact_test/found_DMRS_allClasses_top_
FEATURELISTFILE_BOTTOM="$RESULTFOLDER"/DMRs/sameReadcount10_"$THINNING"/Fishers_exact_test/found_DMRS_allClasses_bottom_

RESULTFOLDER_ourModel="$RESULTFOLDER"/LR_DMRcount/sameReadcount10_"$THINNING"_Fisher
