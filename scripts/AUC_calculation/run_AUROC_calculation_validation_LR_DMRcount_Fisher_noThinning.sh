...
FEATURELISTFILE_TOP="$RESULTFOLDER"/DMRs/noThinning/DMRs_Fisher/found_DMRS_allClasses_top_
FEATURELISTFILE_BOTTOM="$RESULTFOLDER"/DMRs/noThinning/DMRs_Fisher/found_DMRS_allClasses_bottom_

RESULTFOLDER_ourModel="$RESULTFOLDER"/LR_DMRcount/noThinning/LR_DMRcount_Fisher
