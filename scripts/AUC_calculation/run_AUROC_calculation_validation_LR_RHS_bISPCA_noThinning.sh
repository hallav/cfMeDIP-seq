...
PCAFILE="$RESULTFOLDER"/DMRs/noThinning/ISPCA_binary/ISPCA_DMR_results_dataSplit_
RESULTFOLDER_LR="$RESULTFOLDER"/LR_RHS/noThinning/LR_RHS_ISPCA_binary
...
srun Rscript --no-save AUC_calculation_validation_noThinning.R $VAR1 $VAR2 $VAR3 $VAR4 $VAR5 $VAR6 $VAR7 $VAR8 $VAR9 $VAR10 $VAR15 $VAR11 $VAR12 $VAR13 $VAR14 $VAR15 $VAR16 $VAR17 $VAR18 $VAR19 $VAR20
