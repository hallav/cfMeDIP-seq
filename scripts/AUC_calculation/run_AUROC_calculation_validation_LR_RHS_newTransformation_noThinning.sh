...
FEATURELISTFILE="$RESULTFOLDER"/DMRs/newDataSplits/noThinning/DMRs_newTransformation/found_DMRS_allClasses_

OUTPUTFOLDER_ourModel="$RESULTFOLDER"/LR_RHS/noThinning/LR_RHS_newTransformation
