...
#Change THINNING and FEATUREN to go through all DMR numbers and thinning versions. This same script can be used for glmnet Fisher and newTransformation. Input files must be changed accordingly.
THINNING=4
FEATUREN=50

INPUTFILE_training=".../results/thinneddata/wholedata_thinned_allClasses_sameReadcount10_"$THINNING".RData"
INPUTFILE_validation=".../results/thinneddata/validation_thinned_sameReadcount10_"$THINNING".RData"
WHOLE_VALIDATION=".../results/validationData.RData"
...
OUTPUTFOLDER=.../results/AUCs/sameReadcount10_"$THINNING"_validation/wF1AndAccuracy

NAMEID=glmnet_newTransformation_featureN"$FEATUREN"
GP=0
