...
#7 Number of DMRs (hypo+hypermethylated DMRs in total)
...
FeatureList_all <- DMR_finding_Fisher(wholeData_thinned, classes.df = dataSplits$df, Indices = dataSplits$samples[[ID]], nDMR = as.numeric(args[7])) 
