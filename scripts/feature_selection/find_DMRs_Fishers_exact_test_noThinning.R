...
load("StartingPoints.RData") #DOI: 10.5281/zenodo.1490920
...
FeatureList_all <- DMR_finding_Fisher(DataMatrix, classes.df = dataSplits$df, Indices = dataSplits$samples[[ID]], nDMR = 300) 
