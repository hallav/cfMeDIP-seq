...
FeatureList_all <- DMR_finding_modifiedT_noZeroCounts(DataMatrix, classes.df = dataSplits$df, Indices = dataSplits$samples[[ID]], nDMR = strtoi(args[7]), newTransformation=args[8]) 
