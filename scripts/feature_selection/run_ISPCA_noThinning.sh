...
OUTPUTFOLDER="$RESULTFOLDER"/DMRs/newDataSplits/noThinning/ISPCA
...
srun Rscript --no-save ISPCA_noThinning.R $ID $OUTPUTFILE $INPUTFILE $DATASPLITFILE $DMRFILE 0 $NORMALIZE
