...
OUTPUTFOLDER="$RESULTFOLDER"/DMRs/noThinning/DMRs_newTransformation
...
srun Rscript --no-save find_DMRs_modifiedttest_newTransformation_noThinning.R $ID $OUTPUTFILE $INPUTFILE $DATASPLITFILE $OUTPUTFILE_T $OUTPUTFILE_B $NDMR 1
