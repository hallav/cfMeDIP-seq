...
INPUTFOLDER=paste(".../results/AUCs/sameReadcount10_",THINNING,"_validation","/wF1AndAccuracy",sep="")
...
load(paste(INPUTFOLDER,"/validation_AUC_values_glmnet_Fisher_featureN50.RData",sep=""))
glmnet_Fisher_N50_results <- AUC.median.df

load(paste(INPUTFOLDER,"/validation_AUC_values_glmnet_Fisher_featureN200.RData",sep=""))
...
load(paste(INPUTFOLDER,"/validation_AUC_values_glmnet_newTransformation_featureN200.RData",sep=""))
glmnet_newT_N200_results <- AUC.median.df

load(paste(INPUTFOLDER,"/validation_AUC_values_glmnet_newTransformation_featureN50.RData",sep=""))
...
auc.data <- data.frame(
  ...
  auc_median=c(glmnet_newT_N50_results$AUC_median[glmnet_newT_N50_results$method=="glmnet"],
               ...
               glmnet_Fisher_N50_results$AUC_median[glmnet_newT_N50_results$method=="glmnet"],
               glmnet_Fisher_results$AUC_median[glmnet_newT_results$method=="glmnet"],
               glmnet_Fisher_N200_results$AUC_median[glmnet_newT_N200_results$method=="glmnet"]),
  auc_25=c(glmnet_newT_N50_results$AUC_25q[glmnet_newT_N50_results$method=="glmnet"],
           ...
           glmnet_Fisher_N50_results$AUC_25q[glmnet_newT_N50_results$method=="glmnet"],
           glmnet_Fisher_results$AUC_25q[glmnet_newT_results$method=="glmnet"],
           glmnet_Fisher_N200_results$AUC_25q[glmnet_newT_N200_results$method=="glmnet"]),
  auc_75=c(glmnet_newT_N50_results$AUC_75q[glmnet_newT_N50_results$method=="glmnet"],
           ...
           glmnet_Fisher_N50_results$AUC_75q[glmnet_newT_N50_results$method=="glmnet"],
           glmnet_Fisher_results$AUC_75q[glmnet_newT_results$method=="glmnet"],
           glmnet_Fisher_N200_results$AUC_75q[glmnet_newT_N200_results$method=="glmnet"]))
...
pr.auc.data <- data.frame(
  ...
  auc_median=c(glmnet_newT_N50_results$AUPRC_median[glmnet_newT_N50_results$method=="glmnet"],
               ...
               glmnet_Fisher_N50_results$AUPRC_median[glmnet_newT_N50_results$method=="glmnet"],
               glmnet_Fisher_results$AUPRC_median[glmnet_newT_results$method=="glmnet"],
               glmnet_Fisher_N200_results$AUPRC_median[glmnet_newT_N200_results$method=="glmnet"]),
  auc_25=c(glmnet_newT_N50_results$AUPRC_25q[glmnet_newT_N50_results$method=="glmnet"],
           ...
           glmnet_Fisher_N50_results$AUPRC_25q[glmnet_newT_N50_results$method=="glmnet"],
           glmnet_Fisher_results$AUPRC_25q[glmnet_newT_results$method=="glmnet"],
           glmnet_Fisher_N200_results$AUPRC_25q[glmnet_newT_N200_results$method=="glmnet"]),
  auc_75=c(glmnet_newT_N50_results$AUPRC_75q[glmnet_newT_N50_results$method=="glmnet"],
           ...
           glmnet_Fisher_N50_results$AUPRC_75q[glmnet_newT_N50_results$method=="glmnet"],
           glmnet_Fisher_results$AUPRC_75q[glmnet_newT_results$method=="glmnet"],
           glmnet_Fisher_N200_results$AUPRC_75q[glmnet_newT_N200_results$method=="glmnet"]))
...
for(i in 1:N_classes){
  ...
  write.table(round(DM,digits=3),sep="&",quote=FALSE,file=paste(TABLEFOLDER, "/featureNcomparison_validation_median_table_10_",THINNING,"class_", CLASSNAMES[i],".txt",sep=""))
...
FIGNAME<-"AUROC_barplots_validation_featureNcomparison_170mm"
...
FIGNAME<-"AUPRC_barplots_validation_featureNcomparison_170mm"
