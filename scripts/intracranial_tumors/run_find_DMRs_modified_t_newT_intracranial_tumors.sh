...
OUTPUTFOLDER=".../results/DMRs/modifiedt_newTransformation"
...
srun Rscript --no-save find_DMRs_modified_t_test_intracranial_tumors.R $ID $OUTPUTFILE $INPUTFILE $DATASPLITFILE $OUTPUTFILE_T $OUTPUTFILE_B $NDMR 1
