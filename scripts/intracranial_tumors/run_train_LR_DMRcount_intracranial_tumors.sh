...
OUTPUTFILE1=".../results/DMRs/modifiedt_newTransformation/found_DMRS_allClasses_top_"$SLURM_ARRAY_TASK_ID".RData" 
OUTPUTFILE2=".../results/DMRs/modifiedt_newTransformation/found_DMRS_allClasses_bottom_"$SLURM_ARRAY_TASK_ID".RData" 

OUTPUTFOLDER=".../results/LR_DMRcount/LR_DMRcount"
