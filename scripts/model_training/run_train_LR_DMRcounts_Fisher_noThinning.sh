...
DMRFILE1="$RESULTFOLDER"/DMRs/noThinning/DMRs_Fisher/found_DMRS_allClasses_top_"$SLURM_ARRAY_TASK_ID".RData
DMRFILE2="$RESULTFOLDER"/DMRs/noThinning/DMRs_Fisher/found_DMRS_allClasses_bottom_"$SLURM_ARRAY_TASK_ID".RData 

OUTPUTFOLDER="$RESULTFOLDER"/LR_DMRcount/noThinning/LR_DMRcount_Fisher
