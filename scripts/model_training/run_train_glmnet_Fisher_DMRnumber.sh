...
#Change THINNING AND FEATUREN to go through all DMR numbers and data thinning versions
THINNING=6
FEATUREN=50
...
#Here a for loop over ID values could be added
ID=$SLURM_ARRAY_TASK_ID
DMRFILE=".../results/DMRs/sameReadcount10_"$THINNING"/Fishers_exact_test/featureN_"$FEATUREN"/found_DMRS_allClasses_"$ID".RData"

OUTPUTFOLDER=.../results/GLMNET/featureN/N"$FEATUREN"/sameReadcount10_"$THINNING"_Fisher
