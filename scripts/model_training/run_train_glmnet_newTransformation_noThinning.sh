...
DMRFILE="$RESULTFOLDER"/noThinning/DMRs_newTransformation/found_DMRS_allClasses_"$ID".RData

OUTPUTFOLDER="$RESULTFOLDER"/GLMNET/noThinning/glmnet_newTransformation
