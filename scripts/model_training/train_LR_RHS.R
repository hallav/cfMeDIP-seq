...
ourModel.onevEach <- train_LR_RHS_model(Mat = wholeData_thinned, classes.df = dataSplits$df, Indices = dataSplits$samples[[ID]], FeatureList=FeatureList, index=CLASS, parameter_P0=strtoi(args[7]),pairsPlot=pairsplot,dataSplitID=ID)
