...
ourModel.onevEach <- train_LR_RHS_model(DM = wholeData_thinned, classInformation = dataSplits$df, TrainIndices = dataSplits$samples[[ID]], FeatureList=FeatureList, index=CLASS, parameter_P0=strtoi(args[7]),pairsPlot=pairsplot,dataSplitID=ID)
